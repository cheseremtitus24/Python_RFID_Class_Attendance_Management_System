...
def Ready_to_read_card():
    from Windows import ArduinoSerialCom
# todo: if a card is swiped it retrieves all the data related to that card in the database and displays the contents in the tree view
...
btn_scan_card = Button(Buttons, width=10, text="scan_cards", command=Ready_to_read_card)
btn_scan_card.pack(side=LEFT)
